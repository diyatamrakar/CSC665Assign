...
class BFSSearch:
    ...
    def solve(self):
        ...
        while queue:
            ...
            if self.problem.is_end(state):
                return dict(best_cost=cost, best_path=[start] + path, found=True, expanded=len(explored))
        ...
        return dict(best_cost=math.inf, best_path=[], found=False, expanded=len(explored))
